...
def main():
    global key, key_moment, monument_complete, smell, armor
        ...
        #Идти на право
            ...
            if choice == 1:
                ...
                if choice == 1:
                    ...
                    if choice == 2:
                            print('Вы прошли мимо города, перед вами появился волк.')
                            choice = Player_choice(['Убежать обратно',"Попытаться напасть на него"])
                            if choice == 1:
                                print('Вы убежали от волка, вдруг чувствуете резкую боль и обнаруживаете что у вас не хватает почек...')
                                pass
                            if choice == 2:
                                print('Волк очень вкусно покушал...')
                    if choice == 1:
                        ...
                        if choice == 2:
                            ...
                            time.sleep(1)
                            while True:
                                print('Вы находитесь в одиночной камере, перед вами находится дверь, кровать и ведро')
                                choice = Player_choice(['Открыть дверь','Надеть ведро',"Лечь спать"])

                                if choice == 1:
                                    print('Дверь оказалась не закрытой и вы успешло вышли прошмигнув мимо охраны.')
                                    break
                                if choice == 2:
                                    print('На вас вылились продукты жизнедеятельности... Теперь вы воняете')
                                    while True:
                                        print('Вы находитесь в одиночной камере, перед вами находится дверь, кровать и ведро')
                                        choice = Player_choice(['Открыть дверь','Надеть ведро',"Лечь спать"])
                                        if choice == 1:
                                            print('Дверь оказалась не закрытой и вы успешло вышли, Охрана разбежалась от вас от запаха')
                                            break
                                        if choice == 2:
                                            print('Вы надели ведро на грязную голову.')
                                            armor = 1
                                            while True:
                                                print('Вы находитесь в одиночной камере, перед вами находится дверь, кровать')
                                                choice = Player_choice(['Открыть дверь',"Лечь спать"])
                                                if choice == 1:
                                                    print('Дверь оказалась не закрытой и вы успешло вышли, Охрана попыталась вас остановить но вы отбились ведром.')
                                                    break
                                                if choice == 2:
                                                    print('Вы не смогли уснуть из-за запаха.')
                                            break
                                        if choice == 3:
                                            print('Вы не смогли уснуть из-за')
                        if choice == 3:
